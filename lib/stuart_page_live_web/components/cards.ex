defmodule StuartPageLiveWeb.Cards do
  ...
  def project_card(assigns) do
    ~H"""
    <div class="card bg-base-200 card-glow overflow-hidden">
      ...
      <div class="card-body">
        ...
        <div class="card-actions justify-end flex-wrap mt-6 pt-4 border-t border-base-300">
          <a :if={@project.blog} href={@project.blog} target="_blank" class="btn btn-ghost btn-sm">
            Blog Post
          </a>
           <a href={@project.github} target="_blank" class="btn btn-ghost btn-sm">Source</a>
  ...
  def oss_card(assigns) do
    ~H"""
    <div class="card bg-base-200 card-glow overflow-hidden">
      <div class="h-1.5 bg-gradient-to-r from-secondary via-primary to-accent"></div>
      <div class="card-body">
        ...
        <div class="card-actions justify-end flex-wrap mt-6 pt-4 border-t border-base-300">
          <a :if={@oss.blog} href={@oss.blog} target="_blank" class="btn btn-ghost btn-sm">
           ...
           <a href={@oss.hex} target="_blank" class="btn btn-ghost btn-sm">Hex.pm</a>
          <a href={@oss.github} target="_blank" class="btn btn-ghost btn-sm">Source</a>
        </div>
      </div>
    </div>
    """
  ...
  def post_card(assigns) do
    ...
    >
      <div class="card-body flex-col sm:flex-row sm:justify-between sm:items-center py-5 gap-1 sm:gap-4">
